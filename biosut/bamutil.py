...
def extract_reads(bam, ref, out_prefix, output_bam: bool = True,
...
# TODO: infer_identity, infer_align_len_ratio, judge_insert, and judge_edge_alignment.
# TODO: check the coverM code.